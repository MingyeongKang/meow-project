                                ...
                                <span class="blog-wrap-2 mb-30" style="border: 0 solid black;">
                                    <div class="category" style="background-color: #E6E6E6; border-radius: 0.75rem;">
                                        ...
                                        <div style="position: relative; padding: 25px 0; width: 720px;">
                                            <span
                                            style="font-weight: 600; font-size: 1.125rem; line-height: 1.75rem; margin-left: 2.5rem;">간식 공구 게시판</span>
                                        </div>
                                    ...
                                    <div style="display: flex; justify-content: flex-end; margin-top: 20px;">
                                        <button style="margin-right: 10px; border-radius: 10px; width: 60px; height: 38px; background-color: #F5DA81; border: 1px solid white;" onclick="location.href='${pageContext.request.contextPath}/meow/churrcommunity_main'">취소</button>
                                        <button style="border-radius: 10px; width: 60px; height: 38px; background-color: #F5DA81; border: 1px solid white;" onclick="location.href='${pageContext.request.contextPath}/meow/churrcommunity_main'">등록</button>
                                    </div>
                                </span>
                            </div>
                        </div>
