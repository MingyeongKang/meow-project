                            ...
                            <div class="col-md-12 col-sm-12 mx-auto" >
                                <span class="blog-wrap-2 mb-30" style="border: 0 solid black;">
                                    ...
                                    <div id="middleDiv" style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: rgb(128,128,128); text-align: center; position: relative;">
                                        <button onclick="location.href='${pageContext.request.contextPath}/meow/churrcommunity_write'" style="margin-top: 2rem; margin-bottom: 2rem; float: left; background-color: #F5DA81; border-radius: 0.75rem; border: 1px solid white; width: 100px; height: 35px;  color: black;" >작성하기</button>
