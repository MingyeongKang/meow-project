        ...
        <div class="card">
          <div class="card-body">
            <div style="display: flex;">
              ...
              <h5 class="card-title fw-semibold mb-4">일반회원 정보 수정</h5>
              </div>
            <div>
            </div>
            ...
            <div>
              <form style="width: 60%; margin: auto;">
                <div class="mb-4" style="display: flex;">
                  ...
                  <div class="form-label">qwe123</div> <!--아이디는 수정불가-->
                </div>
                <div class="mb-4" style="display: flex;">
                  <div class="form-label" style="width: 19%;">이름</div>
                  <div class="form-label" style="width: 65%;">이마크</div> <!--이름은 관리자만 수정가능(Ajax로 수정)-->
                ...
                <div class="mb-4" style="display: flex;">
                  <label for="exampleInputPassword1" class="form-label" style="margin-right: 10px; width: 17%;">닉네임</label>
                ...
                <div class="mb-4" style="display: flex;">
                  <label for="exampleInputPassword1" class="form-label" style="margin-right: 10px; width: 17%;">회원 상태</label>
                  <select class="selectBox" name="column" id="column" 
                ...
                <br>
                <a href="일반회원_상세.html" class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2" style="font-weight: bold;">수정하기</a>
              </form>
            </div>
