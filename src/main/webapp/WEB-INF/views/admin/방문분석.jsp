...
<div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">방문 분석</h5>
            <div style="width: 35%;">
            ...
            <div class="AdminBottom">                    
              <form action="/AdminDayofTheWeek" method="get" enctype="multipart/form-data" th:object="${searchForm}">
                  <input type="hidden" th:field="*{name}" th:value="${userNum}" />
      
                  <div class="AdminTable">
                      <span class="Title">요일별 조회수 통계 
                        <span th:text="${dateTerm}"></span>
                      </span>
                      
                      <div class="InputDate">
                          <input type="text" id="fromDate" class="Date" placeholder="시작일" th:field="*{fromDate}" autocomplete="off">
                          <span> ~ </span>
                          <input type="text" id="toDate" class="Date" placeholder="종료일" th:field="*{toDate}" autocomplete="off">
                          <a class="DateSearch" th:onclick="SearchHit()"> 
                            <span> 조회 </span> 
                          </a>
                      </div>
                      ...
                      <div class="DayGraphTable">
                          <div class="aGraph">
                              <div th:each="row : ${result}">
                                  <div class="BarBox" th:class="${row.test == i ? 'selected' : ''}">
                                      <span class="Num" th:style="'bottom:' + ${row.CountDay + 1} + '%'"> ${row.CountDay} </span>
                                      <div class="aBar" th:style="'height:' + ${row.CountDay} + '%'"></div>
                                  </div>
                              </div>
                          </div>
